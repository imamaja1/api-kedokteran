    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-header-custom d-flex justify-content-between align-items-center">
                <span><i class="bi bi-pencil-square me-2"></i>Edit Mahasiswa</span>
                <span class="badge bg-light text-dark border font-monospace">{{ $mahasiswa->nim }}</span>
            </div>
                ...
                <form action="{{ route('admin.mahasiswa.update', $mahasiswa->nim) }}" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control bg-light" value="{{ $mahasiswa->nim }}" disabled>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">NIK <span class="text-danger">*</span></label>
                            <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror"
                                value="{{ old('nik', $mahasiswa->nik) }}" maxlength="20">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="npm" class="form-control @error('npm') is-invalid @enderror"
                                value="{{ old('npm', $mahasiswa->npm) }}" maxlength="23">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_mahasiswa"
                                ...
                                value="{{ old('nama_mahasiswa', $mahasiswa->nama_mahasiswa) }}" maxlength="125">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="jenis_kelamin"
                                ...
                                <option value="L" {{ old('jenis_kelamin', $mahasiswa->jenis_kelamin) === 'L' ?
                                    'selected' : '' }}>Laki-laki</option>
                                <option value="P" {{ old('jenis_kelamin', $mahasiswa->jenis_kelamin) === 'P' ?
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="tempat_lahir"
                                ...
                                value="{{ old('tempat_lahir', $mahasiswa->tempat_lahir) }}" maxlength="50">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nomor_pendaftaran"
                                ...
                                value="{{ old('nomor_pendaftaran', $mahasiswa->nomor_pendaftaran) }}" maxlength="13">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nomor_pendaftaran_ulang"
                                ...
                                value="{{ old('nomor_pendaftaran_ulang', $mahasiswa->nomor_pendaftaran_ulang) }}"
                                maxlength="13">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                value="{{ old('email', $mahasiswa->email) }}" maxlength="75">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                value="{{ old('alamat', $mahasiswa->alamat) }}" maxlength="75">
                            @error('alamat') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Kota</label>
                            <input type="text" name="kota" class="form-control @error('kota') is-invalid @enderror"
                                value="{{ old('kota', $mahasiswa->kota) }}" maxlength="50">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-8">
                            ...
                            <select name="program_studi_kode"
                                ...
                                <option value="{{ $ps->kode_program_studi }}" {{ old('program_studi_kode', $mahasiswa->
                                    program_studi_kode) == $ps->kode_program_studi ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="status" class="form-select @error('status') is-invalid @enderror">
                                <option value="A" {{ old('status', $mahasiswa->status) === 'A' ? 'selected' : ''
                                    }}>Aktif</option>
                                <option value="N" {{ old('status', $mahasiswa->status) === 'N' ? 'selected' : ''
                                    }}>Non-Aktif</option>
                            </select>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_ayah"
                                ...
                                value="{{ old('nama_ayah', $mahasiswa->nama_ayah) }}" maxlength="50">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_ibu"
                                ...
                                value="{{ old('nama_ibu', $mahasiswa->nama_ibu) }}" maxlength="50">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="telepon_orangtua"
                                ...
                                value="{{ old('telepon_orangtua', $mahasiswa->telepon_orangtua) }}" maxlength="20">
